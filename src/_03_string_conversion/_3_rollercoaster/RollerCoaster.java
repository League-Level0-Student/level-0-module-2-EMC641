...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		// 2) Ask the user to enter their height in inches using JOptionPane and set it to the variable heightToRide
			String heightToRide = JOptionPane.showInputDialog("Enter your height as inches");
	    ...
	    // "Hurray! You are tall enough to ride the coaster alone!" Hint: use JoptionPane
			if (heightAsInt >=(48))   {
			JOptionPane.showMessageDialog(null, "You are tall enought to ride the roller coaster alone!!!");
				} 
		else {
			JOptionPane.showMessageDialog(null, "You can ride the coaster with someonoe else becuase you must be at least 42 inchest tall to ride the roller coster pal!");
		}
